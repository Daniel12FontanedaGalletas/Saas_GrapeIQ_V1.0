...
from .routers import auth, data, forecast, weather, users, field_log, traceability, cellar_management, ingest, products, parcels, financials, sales, analytics, laboratory
